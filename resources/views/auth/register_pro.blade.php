...
<div class="auth-page-wrapper">
    <div class="auth-card-premium is-wide">
        ...
        <form action="{{ route('register.pro.submit') }}" method="POST">
            ...
            <div class="pro-grid">
                ...
                <div class="left-col">
                    ...
                    <div style="display: flex; gap: 15px;">
                        <div class="fifa-form-group" style="flex: 1;">
                            <label>Prénom *</label>
                            <input type="text" name="prenom" class="fifa-input" 
                                   value="{{ $errors->has('prenom') ? '' : old('prenom') }}" 
                                   required minlength="2" maxlength="50">
                        </div>
                        <div class="fifa-form-group" style="flex: 1;">
                            <label>Nom *</label>
                            <input type="text" name="nom" class="fifa-input" 
                    ...
                    <div class="fifa-form-group">
                        ...
                        <input type="email" name="mail" class="fifa-input" 
                    ...
                    <div style="display: flex; gap: 15px;">
                        <div class="fifa-form-group" style="flex: 1;">
                            ...
                            <input type="date" name="date_naissance" class="fifa-input" 
                    ...
                    <div class="fifa-form-group">
                        ...
                        <input type="text" name="pays_naissance" class="fifa-input" 
                ...
                <div class="right-col" style="background-color: #f8faff; padding: 20px; border-radius: 8px; border: 1px dashed #cce0ff;">
                    ...
                    <div class="fifa-form-group">
                        ...
                        <input type="text" name="nom_societe" id="nom_societe" class="fifa-input" 
                               value="{{ $errors->has('nom_societe') ? '' : old('nom_societe') }}" 
                    ...
                    <div class="fifa-form-group">
                        ...
                        <select name="activite" id="activite" class="fifa-input" required>
                            ...
                            <option value="Revendeur Sport" {{ old('activite') == 'Revendeur Sport' ? 'selected' : '' }}>Revendeur Sport</option>
                            <option value="Club de Football" {{ old('activite') == 'Club de Football' ? 'selected' : '' }}>Club de Football</option>
                            <option value="Evènementiel" {{ old('activite') == 'Evènementiel' ? 'selected' : '' }}>Evènementiel</option>
                    ...
                    <div style="margin-top: 30px; font-size: 0.85em; color: #555; background: #fff; padding: 10px; border-radius: 4px;">
                        ...
                        En créant un compte professionnel, vous certifiez agir au nom de la société mentionnée ci-dessus.
                    </div>
                </div>
                
                <div style="margin-top: 20px; border-top: 1px solid #eee; padding-top: 20px;">
                    <div class="fifa-form-group" style="display: flex; align-items: flex-start; gap: 10px; margin-bottom: 10px;">
                        <input type="checkbox" name="cgu_consent" id="cgu_consent_pro" required style="width: 18px; height: 18px; margin-top: 3px;" {{ old('cgu_consent') ? 'checked' : '' }}>
                    ...
                    <div class="fifa-form-group" style="display: flex; align-items: flex-start; gap: 10px;">
                        <input type="checkbox" name="newsletter_optin" id="newsletter_optin_pro" value="1" style="width: 18px; height: 18px; margin-top: 3px;" {{ old('newsletter_optin') ? 'checked' : '' }}>
            ...
            <button type="submit" class="btn-fifa-submit pro-style">
