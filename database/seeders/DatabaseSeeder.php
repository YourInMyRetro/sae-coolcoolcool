...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 2. Création du Compte SERVICE COMMANDE
        ...
        // 3. Création du Compte EXPÉDITION
        ...
        $id_adresse = DB::table('adresse')->insertGetId([
            'rue' => '10 rue du stade',
            'code_postal_adresse' => '75000',
            'ville_adresse' => 'Paris',
            'pays_adresse' => 'France',
            'type_adresse' => 'Livraison'
        ], 'id_adresse'); // <-- On précise le nom de la clé primaire

        // Lier l'adresse au client
        DB::table('possedeadresse')->insertOrIgnore([
